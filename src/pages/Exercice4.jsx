// client/src/pages/Exercice4.jsx
...
function Exercice4() {
    ...
    async function verifier() {
        ...
        try {
            ...
            const estPositif = await contract.methods.estPositif(val).call();
            setResult(`estPositif(${val}) = ${estPositif}`);
        } catch (error) {
    ...
    return (
        <div style={styles.container}>
            <div style={styles.content}>
                <h1 style={styles.title}> Exercice 4 : Vérifier si un nombre est positif</h1>
                ...
                <div style={styles.card}>
                    <div style={styles.cardTitle}> Vérification</div>
